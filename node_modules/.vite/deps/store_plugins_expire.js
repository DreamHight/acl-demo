...
// node_modules/.pnpm/store@2.0.12/node_modules/store/plugins/expire.js
var require_expire = __commonJS({
  "node_modules/.pnpm/store@2.0.12/node_modules/store/plugins/expire.js"(exports, module) {
    ...
    function expirePlugin() {
      ...
      function _checkExpiration(key) {
        ...
        if (expiration <= (/* @__PURE__ */ new Date()).getTime()) {
          this.raw.remove(key);
          expirations.remove(key);
        }
      }
